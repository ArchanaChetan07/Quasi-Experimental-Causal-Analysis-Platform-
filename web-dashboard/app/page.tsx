...
export default function DashboardPage() {
  ...
  return (
    <main className="container" id="main-content">
      ...
      >
        <div className="card">
          ...
          <p className="sr-only">
            ...
            indicating a parallel trends violation in the pooled sample. See the table
            below the chart, or the raw event_study_pooled.csv, for exact values.
          </p>
        </div>
      </Section>
      ...
      >
        <div className="card">
          <CohortAttChart data={cohortAtt} twfeAtt={summary.twfe.att} />
